      ...
      child: Container(
        ...
        child:   Column(
          children: [
            ...
            Column(
              children: List.generate(word.tagsControllers.length ,  (index){
                return Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Column(
                        children: [
                          WordDetailsTextField(text: "tag", controller: word.tagsControllers[index] , maxLine: false,), 
                        ],
                      ) ,
                       Padding(
